/*
 * mmc.c
 * This file will contain the necessary low level implementation to get the memory card going
...
{
	BYTE d;
	GPIOSetBitValue(SSP0_SSELPORT, SSP0_SSELPIN, HIGH);
...
{
	BYTE d;
	GPIOSetBitValue(SSP0_SSELPORT, SSP0_SSELPIN, LOW);
...
)
{
	...
	SSP0_Init();				/* Initialize control port */
